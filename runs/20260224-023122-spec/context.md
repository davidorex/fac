...
Current time: 2026-02-24T02:31:22.055699
...
A Python script that prints "Hello from the factory" and the current date/time.
It should accept an optional --name flag to personalize the greeting.
